...
const Conditions = () => {
    return (
        <div className="privacyContainer">
            ...
            <hr />
            <h4>OVERVIEW</h4>
            <p>This website is operated by Crown Clothing Inc.. Throughout the site, the terms “we”, “us” and “our” refer to Crown Clothing Inc.. Crown Clothing Inc. offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here. <br />
...
<p>Questions about the Terms of Service should be sent to us atinfo@crownclothinginc.com.</p>
<br />
<hr />
        </div>
    );
