...
const Privacy = () => {
    return (
        <div className="privacyContainer">
            ...
            <hr />
            <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from crown-clothing-inc-store.myshopify.com (the “Site”).</p>
...
<h4>Contact us</h4>
<p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at info@crownclothinginc.com
<br />
Crown Clothing Inc</p>
<br />
<hr />
        </div>
    );
